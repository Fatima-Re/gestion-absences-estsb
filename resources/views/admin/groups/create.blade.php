        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.groups.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <input id="max_students" type="number" class="form-control @error('max_students') is-invalid @enderror" name="max_students" value="{{ old('max_students') }}" required min="1" max="100">
                        @error('max_students')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-9">
                        <input id="academic_year" type="text" class="form-control @error('academic_year') is-invalid @enderror" name="academic_year" value="{{ old('academic_year') }}" required>
                        @error('academic_year')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
